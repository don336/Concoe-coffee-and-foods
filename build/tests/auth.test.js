...
describe('User Auth', function () {
  ...
  it(
    'should not register when required fields are empty',
    /*#__PURE__*/ _asyncToGenerator(
            ...
            switch ((_context4.prev = _context4.next)) {
              ...
              case 2:
                ...
                expect(res.body.message).toBe(
                  'Please fillout the required fields'
                );
              case 5:
              case 'end':
  ...
  it(
    'should not register an already taken Email',
    /*#__PURE__*/ _asyncToGenerator(
  ...
  it(
    'should not register an already taken username',
    /*#__PURE__*/ _asyncToGenerator(
  ...
  it(
    'should register a user with a unique username and email',
    /*#__PURE__*/ _asyncToGenerator(
  ...
  it(
    'should not signin when required fields are empty',
    /*#__PURE__*/ _asyncToGenerator(
          ...
          while (1)
            switch ((_context8.prev = _context8.next)) {
              ...
              case 2:
                ...
                expect(res.status).toBe(422);
                expect(res.body.message).toBe(
                  'Please fillout all necessary fields'
                );
              case 5:
              case 'end':
  ...
  it(
    "shouldn't signIn a user with a none existing email",
    /*#__PURE__*/ _asyncToGenerator(
  ...
  it(
    'shouldnot signIn a user with an incorrect password',
    /*#__PURE__*/ _asyncToGenerator(
  ...
  it(
    'should signIn a user with an exisitng email and password',
    /*#__PURE__*/ _asyncToGenerator(
